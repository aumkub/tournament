/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 48bd9aac9596f255164dd83eaf5ce3be)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "TournamentRoom";
	}
	interface Env {
		SESSIONS: KVNamespace;
		EMAIL_FROM: "welcome@gooddrive.golf";
		EMAIL_FROM_NAME: "GoodDrive Golf";
		TOURNAMENT_ROOM: DurableObjectNamespace<import("./workers/app").TournamentRoom>;
		BUCKET: R2Bucket;
		BUCKET_REMOTE: R2Bucket;
		DB: D1Database;
		EMAIL_QUEUE: Queue;
		EMAIL: SendEmail;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "EMAIL_FROM_NAME">> {}
}
